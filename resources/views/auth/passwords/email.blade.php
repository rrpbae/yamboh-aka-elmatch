    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="premium-card text-center border-0" style="padding: 48px 40px;">
                ...
                <h3 style="font-weight: 700; color: var(--text-main); margin-bottom: 8px;">Lupa Kata Sandi</h3>
                <p style="color: var(--text-muted); font-size: 0.95rem; margin-bottom: 32px;">Masukkan email Anda dan kami akan mengirimkan tautan untuk mengatur ulang kata sandi.</p>

                @if (session('status'))
                    <div class="alert alert-success" style="background: var(--success-light); color: var(--success-color); border: 1px solid var(--success-color); border-radius: 8px; font-weight: 600;" role="alert">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('password.email') }}" class="text-start">
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('login') }}" style="color: var(--text-muted); font-weight: 600; font-size: 0.9rem; text-decoration: none; display: inline-flex; align-items: center;">
